...
namespace BankAccount
{
    public class MonthlyStatement
    {
        ...
        private int _DayCount = 0;
            ...
            /*
        private List<float> _Deposits = new List<float>();
        private List<float> _Withdrawals = new List<float>();
        private List<float> _Balance = new List<float>();
        private List<float> _DailyInterest = new List<float>();
        private int _DayCount = 0;
        */
